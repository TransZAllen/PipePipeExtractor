...
//        }
    ...
    public List<SubtitlesStream> getSubtitles(final MediaFormat format) throws ParsingException {
        ...
        for (int i = 0; i < captionsArray.size(); i++) {
            ...
            if (languageCode != null && baseUrl != null && vssId != null) {
                ...
                if (translatableSubtitle == null) {
                    ...
                    translatableSubtitle = updateTranslatableSubtitleContent(
        ...
        if (translatableSubtitle != null && !hasFoundContentLanguage) {
            String remoteSubtitleUrl = translatableSubtitle.getContent();
            remoteSubtitleUrl = remoteSubtitleUrl + "&tlang=" + contentLanguage;
